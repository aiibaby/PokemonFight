import { SELECTED_POKEMON_MARK, CURRENT_POKEMON_SET, TEAM_SET, SET_OPPONENT_TEAM, SET_MOVE, SET_OPPONENT_POKEMON, SET_OPPONENT_POKEMON_HEALTH, REMOVE_POKEMON_FROM_OPPONENT_TEAM} from "./types";
